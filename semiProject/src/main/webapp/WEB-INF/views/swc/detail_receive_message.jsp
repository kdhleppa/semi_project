        ...
        <div class="mainpart">
            ...
            <div class="content">
                ...
                <div style="display: flex;">
                    ...
                    <div>
                        <input type="text" style="font-size: 18px; width: 550px; height: 40px;" placeholder="제목1">
                    </div>
                </div>
                ...
                <div style="display: flex;">
                    ...
                    <div>
                        <textarea style="font-size: 20px; width: 550px; height: 350px;">내용1</textarea>
                    </div>
                </div>

                <div>
                    <button id="btnbox"> <a href="/link/writeMessage">답장하기</a> </button>
                    <button id="btnbox" class="messageDelete" style="margin-left: 20px;">삭제</button>
                </div>
