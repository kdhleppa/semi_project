...
<head>
    ...
    <title>투룸 등록한 매물 수정 (매물 수정 투룸)</title>
    <link rel="stylesheet" href="/src/main/webapp/resources/css/edit_property(two_room).css">
        ...
        <div class="container">
            ...
            <div id="title">
                ...
                <div id="bottom-title">
                    ...
                    전/ 월세 매물만 등록할 수 있습니다.<br>
                        1. 주소를 다르게 입력할 경우 허위매물로 신고될 수 있으니 꼭 동일하게 입력 바랍니다.<br>
                        2. 등록한 매물은 30일 간 노출됩니다. <br>
            ...
            <div class="footer">
                ...
                <div id="registration">
                    ...
                    <button id="registration-btn">수정하기</button>
